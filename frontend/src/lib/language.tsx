...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    staffDashboardSubtitle: "Suivez les commandes depuis l'appel de confirmation jusqu'à la livraison.",
    manageOrders: "Gérer les commandes",
    recentOrdersSort: "Tri des commandes récentes",
    selectSortOption: "Sélectionnez une option ci-dessous pour trier",
    loadingDashboard: "Chargement du tableau de bord...",
    requiresAction: "Nécessite une action",
    requiresActionDesc: "Appel en attente, préparation livraison, ou en transit",
    totalOrders: "Commandes totales",
    staffProducts: "Produits",
    manageProducts: "Gérer les produits",
    revenue: "Revenu",
    customersCount: "clients",
    categoriesCount: "catégories",
    awaitingConfirmationCall: "En attente d'appel de confirmation",
    ...
    sortDateNewest: "Date, de la plus récente à la plus ancienne",
    sortDateOldest: "Date, de la plus ancienne à la plus récente",
    sortCustomerAZ: "Client, de A à Z",
    sortCustomerZA: "Client, de Z à A",

    // Order Management
    orderManagement: "Gestion des commandes",
    orderManagementSubtitle: "Appelez le client pour confirmer, puis faites évoluer la commande jusqu'à la livraison.",
    refresh: "Actualiser",
    requiresActionBadge: "nécessite une action",
    year: "Année",
    allYears: "Toutes",
    orderTitle: "Commande",
    guest: "Invité",
    placedOn: "Passée le",
    statusUpdatedOn: "Statut mis à jour le",
    call: "Appeler",
    note: "Note",
    invoice: "FACTURE",
    ...
    approvedNeedDelivery: "APPROUVÉ - BESOIN LIVRAISON",
    noAnswerOnCall: "PAS DE RÉPONSE À L'APPEL",
    rejected: "REJETÉ",
    cancelled: "ANNULÉ",
    confirmDelete: "Êtes-vous sûr de vouloir supprimer cette commande ? Cette action ne peut pas être annulée.",

    // Order Status Labels
    statusPendingApprovalCall: "Besoin d'approbation (appel)",
    statusNoAnswerOnCall: "Pas de réponse à l'appel",
    statusApprovedNeedDelivery: "Approuvé - besoin livraison",
    statusOnDelivery: "En livraison",
    statusApprovedDelivered: "Approuvé et livré",
    statusRejected: "Rejeté",
    statusRejectedAfterDelivery: "Rejeté après livraison",
    statusReturnedAfterDelivery: "Retourné après livraison",
  ...
  en: {
    ...
    staffDashboardSubtitle: "Track orders from confirmation call to delivery.",
    manageOrders: "Manage Orders",
    recentOrdersSort: "Recent Orders Sort",
    selectSortOption: "Select an option below to sort",
    loadingDashboard: "Loading dashboard...",
    requiresAction: "Requires Action",
    requiresActionDesc: "Pending call, delivery preparation, or in transit",
    ...
    awaitingConfirmationCall: "Awaiting Confirmation Call",
    ...
    sortDateNewest: "Date, newest to oldest",
    sortDateOldest: "Date, oldest to newest",
    sortCustomerAZ: "Customer, A to Z",
    sortCustomerZA: "Customer, Z to A",

    // Order Management
    orderManagement: "Order Management",
    orderManagementSubtitle: "Call the customer to confirm, then progress the order to delivery.",
    refresh: "Refresh",
    requiresActionBadge: "requires action",
    year: "Year",
    allYears: "All",
    orderTitle: "Order",
    guest: "Guest",
    ...
    approvedNeedDelivery: "APPROVED - NEED DELIVERY",
    noAnswerOnCall: "NO ANSWER ON CALL",
    rejected: "REJECTED",
    cancelled: "CANCELLED",
    confirmDelete: "Are you sure you want to delete this order? This action cannot be undone.",

    // Order Status Labels
    statusPendingApprovalCall: "Need approval (call)",
    statusNoAnswerOnCall: "No answer on call",
    statusApprovedNeedDelivery: "Approved – need delivery",
    statusOnDelivery: "On delivery",
    statusApprovedDelivered: "Approved & delivered",
    statusRejected: "Rejected",
    statusRejectedAfterDelivery: "Rejected after delivery",
    statusReturnedAfterDelivery: "Returned after delivery",
  ...
  ar: {
    ...
    staffDashboardSubtitle: "تتبع الطلبات من مكالمة التأكيد حتى التوصيل.",
    manageOrders: "إدارة الطلبات",
    recentOrdersSort: "ترتيب الطلبات الأخيرة",
    selectSortOption: "حدد خياراً أدناه للترتيب",
    loadingDashboard: "جاري تحميل لوحة التحكم...",
    requiresAction: "يتطلب إجراءً",
    requiresActionDesc: "مكالمة معلقة، تحضير التوصيل، أو في الطريق",
    totalOrders: "إجمالي الطلبات",
    staffProducts: "المنتجات",
    manageProducts: "إدارة المنتجات",
    revenue: "الإيرادات",
    customersCount: "عملاء",
    categoriesCount: "فئات",
    awaitingConfirmationCall: "في انتظار مكالمة التأكيد",
    ...
    sortDateNewest: "التاريخ، من الأحدث إلى الأقدم",
    sortDateOldest: "التاريخ، من الأقدم إلى الأحدث",
    sortCustomerAZ: "العميل، من أ إلى ي",
    sortCustomerZA: "العميل، من ي إلى أ",

    // Order Management
    orderManagement: "إدارة الطلبات",
    orderManagementSubtitle: "اتصل بالعميل للتأكيد، ثم تقدم الطلب حتى التوصيل.",
    refresh: "تحديث",
    requiresActionBadge: "يتطلب إجراءً",
    year: "السنة",
    allYears: "الكل",
    orderTitle: "الطلب",
    guest: "ضيف",
    placedOn: "تم الطلب في",
    statusUpdatedOn: "تم تحديث الحالة في",
    call: "اتصال",
    note: "ملاحظة",
    invoice: "فاتورة",
    deliveryNote: "إيصال تسليم",
    delete: "حذف",
    updateStatus: "تحديث الحالة",
    approvedNeedDelivery: "موافق - يحتاج تسليم",
    noAnswerOnCall: "لا يوجد رد على الاتصال",
    rejected: "مرفوض",
    cancelled: "ملغي",
    confirmDelete: "هل أنت متأكد من حذف هذا الطلب؟ لا يمكن التراجع عن هذا الإجراء.",

    // Order Status Labels
    statusPendingApprovalCall: "يحتاج موافقة (اتصال)",
    statusNoAnswerOnCall: "لا يوجد رد على الاتصال",
    statusApprovedNeedDelivery: "موافق - يحتاج تسليم",
    statusOnDelivery: "جاري التوصيل",
    statusApprovedDelivered: "موافق ومسلم",
    statusRejected: "مرفوض",
    statusRejectedAfterDelivery: "مرفوض بعد التوصيل",
    statusReturnedAfterDelivery: "مسترجع بعد التوصيل",
