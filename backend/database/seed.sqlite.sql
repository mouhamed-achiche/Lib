...
-- Insert products
INSERT OR IGNORE INTO products (id, name, slug, description, price, sale_price, stock_qty, category_id, brand_id, badge, image_url) VALUES
...
-- Insert staff user (password: M14WpSo3XvDiAKXd1ecvgnP3UdOKVjRGpq)
INSERT OR IGNORE INTO users (id, name, email, password, role) VALUES
...
INSERT OR IGNORE INTO homepage_sections (id, title, slug, description, order_num, is_active) VALUES
